    ...
    <div>
      <header className="relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3">
          ...
          <div className="flex items-center justify-between">
            <a className="flex-none text-xl font-semibold focus:outline-none focus:opacity-80" href="#" aria-label="Brand">
              <span className="inline-flex items-center gap-x-2 text-xl font-semibold">
                ...
                SK  <span className="text-gray-400">Under Construction</span>
              </span>
            </a>
        ...
        <a className="font-medium text-gray-600 hover:text-gray-400 focus:outline-none focus:text-gray-400" href="#">Account</a> */}
              ...
              <a><Button variant="outline" size="icon" className="bg-gray-400 hover:bg-gray-300 hover:cursor-pointer" onClick={() => {
                setTheme(theme === Theme.Light ? Theme.Dark : Theme.Light);
                toast(`Page Theme set to: ${theme === Theme.Light ? "Dark" : "Light"}`)
                console.log(theme);
              }} >
                <img className="relative" style={{ width: '20px' }} src={themeIcon} alt="theme icon" />
              </Button>
              </a>
            </div>
          </div>
